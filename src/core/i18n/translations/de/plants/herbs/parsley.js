      ...
      seasonalTiming: {
        temperate_north: {
          plantingWindow: {
            ...
            description: 'Nach dem letzten Frost, zweijährige Pflanze',
          },
          harvestWindow: {
            start: '05-15',
            end: '10-15',
            description: 'Kontinuierliche Ernte im ersten Jahr',
          },
        },
        mediterranean: {
          plantingWindow: {
            ...
            description: 'Früher Start für zweijährige Pflanze',
          },
          harvestWindow: {
            start: '04-15',
            end: '11-15',
